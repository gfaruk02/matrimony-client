            ...
            <section className="bg-blue-950 text-gray-100">
                <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                    ...
                    <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                        <div>
                            <h3 className="text-2xl font-bold tracki sm:text-3xl text-gray-50">How Media Works</h3>
                            <p className="mt-3 text-lg text-gray-400">Get Started in 3 Easy Steps.</p>
                            <div className="mt-12 space-y-12">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="ml-4">
                                        <h4 className="text-lg font-medium leadi text-gray-50">Search Your Partner</h4>
                                        <p className="mt-2 text-gray-400">Search your preferred partner by location, education, interest and so on</p>
                                    </div>
                                </div>
                                <div className="flex">
                                    <div className="flex-shrink-0">
                                    ...
                                    <div className="ml-4">
                                        <h4 className="text-lg font-medium leadi text-gray-50">Start Communication</h4>
                                        <p className="mt-2 text-gray-400">Start communication with suitable profiles by sending message & emails</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                            <div className="lg:col-start-2">
                                <h3 className="text-2xl font-bold tracki sm:text-3xl text-gray-50">Why Our Services Best</h3>
