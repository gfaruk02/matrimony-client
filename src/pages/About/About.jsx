const About = () => {
    return (
        <div>
            <section className="p-4 mt-16 lg:p-8 bg-gray-800 text-gray-100">
                <div className="container mx-auto space-y-12">
                    ...
                    <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row-reverse">
                        ...
                        <div className="flex flex-col justify-center flex-1 p-6 bg-gray-900">
                            ...
                            <p className="my-6 text-gray-400">Our platform offers a diverse range of profiles, representing various backgrounds, cultures, and preferences. We embrace diversity and celebrate the uniqueness of each individual. Whether you are seeking a partner based on shared values, beliefs, or interests, we provide the tools to help you find your perfect match.

                                We understand the significance of this journey in your life, and we are honored to be a part of it. Our dedicated team is here to support you, offering guidance and assistance whenever you need it.
                                ...
                                Thank you for choosing Matrimony—where meaningful connections blossom into lifelong partnerships.</p>
                            <button type="button" className="self-start">Action</button>
                        </div>
                    </div>
                    <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
